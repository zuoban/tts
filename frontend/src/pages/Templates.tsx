          ...
          <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="relative group">
               ...
               <p className="text-gray-400 font-mono text-sm tracking-wide">
                 管理您的常用文本 <span className="text-green-500/50">///</span> {templates.length} 个模板
               </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto">
                ...
                <div className="relative group flex-1 md:w-64">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg className="h-4 w-4 text-gray-500 group-focus-within:text-green-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <input
                        ...
                        placeholder="搜索..."
                        className="block w-full pl-9 pr-4 py-2 bg-gray-900/50 border border-gray-700 rounded-lg text-sm text-gray-100 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-green-500/50 focus:border-green-500/50 transition-all duration-300 backdrop-blur-sm"
                    />
                </div>
                ...
                <div className="flex gap-3 shrink-0">
                    ...
                    <button
                        onClick={handleAdd}
                        className="flex items-center gap-2 px-6 py-2 rounded-lg bg-green-500 text-white font-medium hover:bg-green-400 shadow-[0_0_15px_rgba(34,197,94,0.3)] hover:shadow-[0_0_25px_rgba(34,197,94,0.5)] transition-all duration-300 whitespace-nowrap"
                    >
                        ...
                        {filteredTemplates.map((template, index) => (
                            ...
                            {(provided, snapshot) => (
                                ...
                                className={`
                                    ...
                                    ${snapshot.isDragging 
                                        ? 'shadow-2xl ring-1 ring-green-500/50 z-50 bg-gray-800' 
                                ...
                                >
                                {/* 装饰线 */}
                                <div className="absolute top-0 bottom-0 left-0 w-1 bg-gradient-to-b from-green-500 to-emerald-500 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                
                                <div className="flex items-start p-3 gap-3">
                                    {/* 拖拽手柄 */}
                                    <div
                                        {...provided.dragHandleProps}
                                        className="mt-0.5 flex-shrink-0 w-6 h-6 flex items-center justify-center rounded text-gray-600 group-hover:text-gray-400 hover:bg-gray-700/50 transition-colors cursor-grab active:cursor-grabbing"
                                    >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-start justify-between gap-3 mb-2">
                                            <div>
                                                <h4 className="text-base font-bold text-gray-200 group-hover:text-green-400 transition-colors truncate mb-0.5">
                                                    {template.title}
                                                </h4>
                                            ...
                                            <div className="flex items-center gap-1 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-200">
                                                ...
                                                className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-green-500/10 hover:text-green-400 text-gray-500 transition-colors"
                                                title="编辑"
                                                >
                                                ...
                                                className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-red-500/10 hover:text-red-400 text-gray-500 transition-colors"
                                                title="删除"
                                                >
                                                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                                        ...
                                        <p className="text-gray-400 text-xs line-clamp-2 leading-relaxed bg-gray-900/50 p-2.5 rounded-lg border border-gray-800">
                                            {template.content}
                                        </p>
                                    </div>
                                </div>
            ...
            <div className="p-8">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <Input
                    ...
                    className="bg-gray-800/50 border-gray-700 text-white placeholder-gray-600 focus:border-green-500 focus:ring-green-500/20 text-lg"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-400 mb-2 uppercase tracking-wider font-mono">
                  ...
                  <textarea
                    ...
                    rows={8}
                    className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl text-white placeholder-gray-600 focus:outline-none focus:border-green-500 focus:ring-4 focus:ring-green-500/10 resize-none transition-all duration-200"
                  />
                </div>
                {formError && (
              ...
              <div className="mt-10 flex justify-end gap-4">
                ...
                <button 
                    ...
                    className="px-8 py-2.5 rounded-lg bg-gradient-to-r from-green-600 to-emerald-600 text-white font-medium hover:from-green-500 hover:to-emerald-500 shadow-lg shadow-green-500/20 hover:shadow-green-500/40 transition-all duration-300 transform hover:-translate-y-0.5"
                >
